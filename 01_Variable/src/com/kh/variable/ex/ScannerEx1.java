...
public class ScannerEx1 {
	...
	public static void main(String[] args) {
		...
		Scanner.nextLine() : 공백포함해서 문자열 1개 입력
		...
		스캐너는 불러운 다음 close를 사용해서 공간을 닫아주는 표시를 해주는게 좋음
		*/ 
		...
		// 그런데 버퍼값은 우리가 눈으로 보거나 저장을 해야할 이유가 필요 없기 때문에
		// 앞에 자료형이나 변수명을 사용해서 버퍼를 넣어 저장해야 할 이유가
		...
		// Scanner 사용을 다 했다면 공간을 차지하기 않기 위해서
		// Scanner 를 종료하는 close를 사용해서 닫아주기
		sc.close(); 
