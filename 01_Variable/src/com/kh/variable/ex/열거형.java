...
메서드
	...
	valuesOf(String 이름) : 이름과 일치하는 Enum 상수를 반환
	ordinal()			: Enum 상수의 순서를 전달
	name()				: 다른 enum 상수와 순서 비교
	toString()			: Enum 상수의 문자열 표현 
...
public class 열거형 {
	...
	public static void main(String[] args) {
		...
		System.out.println("겨울 상수의 순서 : "+봄.ordinal());
		//name() : 상수의 이름을 전달
