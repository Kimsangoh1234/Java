...
public class Variable {
	...
	public static void main(String[] args) {
		...
		//int 자료형 선언 선언이름 nt nt안에 숫자 2 넣고 출력하기
		...
		// 띄어쓰기를 넣고 싶은 경우 "" 큰 따옴표 내부에 띄어쓰기를 넣어야 함
		
		// 정수 + 문자 + 문자열 출력하기
		/*
		 안녕하세요. 저는요. 서울에 사는 김상오입니다.
		 제 전화번호는 111-222-3333입니다.
		 제 주민번호는 비밀입니다.
		 제 혈액형은 A형입니다.
		 **/
		String greeting = "안녕하세요.";
		String introduction = "저는요. 서울에 사는 김상오입니다.";
		...
		//4.실수 5.논리형
		// 실수는 float과 double이 있음
		// 실수는 기본으로 double 형식으로 되어있음
		// float = 4byte double = 8byte
		// float에 실수를 담기 위해서는 f를 붙여줘야 함
		// 실수 뒤에 f를 붙일 때 대소문자 구분 없이 사용 가능
		float ff = 3.14f;
		float ff2 = 3.14F;
		System.out.println("ff 은 : " +ff + " 이다.");
		...
		char tq = 'U';
		System.out.println("문자 ch의 값" +tq);
