...
public class StringPre {
	...
	public static void main(String[] args) {
		...
		//toLowerCase 메서드를 사용해서 모두 대문자로 변환
		...
		String 그의 = 문제7.substring(14);
		System.out.println(그의);
	}
