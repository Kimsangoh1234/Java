...
//이와 개발자가 실행하고자 하는 내용은 class 내부에 작성해줘야함.
public class OperatorEX2 {
	...
	public static void 메서드3( ) {
		...
		System.out.print("num5숫자를 입력하세요.");
		//키보드로 작성한 숫자가 num5로 들어올 수 있게 변수 선언
		int num5 = sc.nextInt(); 
		System.out.print("num6숫자를 입력하세요.");
		//키보드로 작성한 숫자가 num6로 들어올 수 있게 변수 선언
		int num6 = sc.nextInt();
		//키보드로 전달받은 숫자를 더하기 빼기 곱하기 나누기 할 수 있음
		int sum1 = num5 +num6;
		int sub1 = num5-num6;
		int mul1 = num5*num6;
		int div1 = num5/num6;
	...
	public static void 메서드4() {
		...
		System.out.print("num7숫자를 입력하세요.");
		double num7 = sc.nextDouble();
		System.out.print("num8숫자를 입력하세요.");
